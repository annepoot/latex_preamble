...
\newcommand*{\lagrangemultiplier}{\mu}
...
\newcommand*{\displacementcomponent}{u}
...
\newcommand*{\informationoperator}{\opJ}
\newcommand*{\informationoperation}{\mathcal{j}}
...
\newcommand*{\truemeshsize}{\true{\meshsize}}
...
\newcommand*{\reference}[1]{\smash{\tilde{#1}}}
\newcommand*{\referencemeshsize}{\reference{\meshsize}}
\newcommand*{\referencefem}[1]{#1^{\referencemeshsize}}
\newcommand*{\referencereferencefem}[1]{\referencefem{\reference{#1}}}
...
\newcommand*{\referencesolutionspace}{\referencereferencefem{\solutionspace}}
...
\newcommand*{\referencemesh}{\referencereferencefem{\meshsymbol}}
...
% Hypermesh stuff
\newcommand*{\hyper}[1]{\smash{\hat{#1}}}
\newcommand*{\hypermeshsize}{\hyper{\meshsize}}
\newcommand*{\hyperfem}[1]{#1^{\hypermeshsize}}
\newcommand*{\hyperhyperfem}[1]{\hyperfem{\hyper{#1}}}

\newcommand*{\hyperstiffnessmatrix}{\hyper{\mK}}
\newcommand*{\hyperobservationinterpolationmatrix}{\hyper{\mPhi}}
\newcommand*{\hypersolutionspace}{\hyperhyperfem{\solutionspace}}
\newcommand*{\hypermesh}{\hyperhyperfem{\meshsymbol}}

\newcommand*{\hyperreference}[1]{\smash{\hat{\tilde{#1}}}}
\newcommand*{\hyperreferenceinterpolationmatrix}{\hyperreference{\mPhi}}

% GP regression stuff
\newcommand*{\meanfunction}{\mu}
\newcommand*{\kernelfunction}{\Sigma}
...
\newcommand*{\parametrizedstiffnessmatrix}{\stiffnessmatrix_\parameters}
...
\newcommand*{\observationoperator}{\opG}
...
\newcommand*{\bfempriormean}{\meanfunction}
\newcommand*{\bfempriorkernel}{\kernelfunction}
\newcommand*{\bfempriorcovariance}{\opS}
\newcommand*{\bfemposteriormean}{\meanfunction_*}
\newcommand*{\bfemposteriorkernel}{\kernelfunction_*}
...
\newcommand*{\bfempriorstdvector}{\vsigma}
...
\newcommand*{\bfempriorcovariancematrixrhsbcs}{\tilde{\bfempriorcovariancematrix}_\mathrm{f}}
...
\newcommand*{\errorvector}{\reference{\ve}}
...
\newcommand*{\bfemrescaledposteriorcovariancematrix}{\hat{\mSigma}_*}
...
% BFEM sampling stuff
\newcommand*{\bfemreferencesolutionpriorsample}[1]{\referencesolutionvector^{(#1)}}
\newcommand*{\bfemreferencesourcepriorsample}[1]{\referencesourcevector^{(#1)}}
\newcommand*{\bfemreferencesolutionposteriorsample}[1]{\referencesolutionvector_*^{(#1)}}
\newcommand*{\bfemreferencesourceposteriorsample}[1]{\referencesourcevector_*^{(#1)}}
\newcommand*{\bfemreferencesolutionpriorsamplematrix}{\mU}
\newcommand*{\bfemposteriorsamplemeanvector}{\hat{\bfempriormeanvector}_*}
\newcommand*{\bfemposteriorsamplecovariancematrix}{\hat{\bfempriorcovariancematrix}_*}
...
\newcommand*{\bfemobservationnoisesample}[1]{\bfemobservationnoise^{(#1)}}
...
\newcommand*{\youngsmodulusfiber}{\youngsmodulus_\text{incl}}
\newcommand*{\poissonsratiofiber}{\poissonsratio_\text{incl}}
\newcommand*{\youngsmodulusmatrix}{\youngsmodulus_\text{mtrx}}
\newcommand*{\poissonsratiomatrix}{\poissonsratio_\text{mtrx}}
\newcommand*{\degradation}{\gamma}
\newcommand*{\degradationfunc}{\delta}
\newcommand*{\degradationbase}{\degradation_0}
\newcommand*{\sigmoid}{\sigma}
\newcommand*{\fiberdistance}{s}
\newcommand*{\inducingpoints}{\vs}
\newcommand*{\logitdegradation}{\xi}
\newcommand*{\degradationkernel}{\kernelfunction_\logitdegradation}
\newcommand*{\degradationlength}{\lengthscale_\logitdegradation}
\newcommand*{\degradationscale}{\variancescale_\logitdegradation}
