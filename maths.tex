...
\usepackage{mathtools}      % provides \smallmatrix command
...
\newcommand*{\probabilityof}[2][]{p\left(#2 \ifstrempty{#1}{}{|#1} \right)}
\newcommand*{\proposalof}[1]{q\left(#1\right)}
...
\newcommand*{\diagof}[1]{\diag\left(#1\right)}
\newcommand*{\argmaxof}[1]{\argmax\left(#1\right)}
\newcommand*{\argminof}[1]{\argmin\left(#1\right)}
\newcommand*{\linspanof}[1]{\linspan\left(#1\right)}
\newcommand*{\rankof}[1]{\rank\left(#1\right)}

\newcommand*{\innerproduct}[3][]{\langle #2, #3 \rangle\ifstrempty{#1}{}{_{#1}}}
\newcommand*{\collection}[3]{\left\{#1, #2, \dots, #3\right\}}
