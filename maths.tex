...
\newcommand*{\dirac}[1]{\delta\parens*{#1}}
...
\newcommand*{\varianceof}[1]{\variance\parens{#1}}
\newcommand*{\covarianceof}[2]{\covariance\parens*{#1, #2}}
...
\newcommand*{\argmaxof}[2][]{\argmax\ifstrempty{#1}{}{_{#1}}\parens*{#2}}
\newcommand*{\argminof}[2][]{\argmin\ifstrempty{#1}{}{_{#1}}\parens*{#2}}
